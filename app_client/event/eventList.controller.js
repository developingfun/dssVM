...
eventListCtrl.$inject = ['$scope','$window','eventData','volunteerData','$uibModal'];
function eventListCtrl ($scope,$window, eventData,volunteerData, $uibModal) {
	...
	vm.getData = function() {
		console.log('eventListCtrl .. getData');
		vm.message ="getting information........";
			eventData.events()
			    .then(function successCallback(response) {
					    ...
					    .then(function successCallback(response1) {
							...
							vm.totalItems = vm.data.events.length;
